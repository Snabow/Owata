...
**Authority:** Program Control (OWATA-REQ-0102; OWATA-REQ-0103; OWATA-REQ-0104; OWATA-REQ-0106)
...
- `UNKNOWN` → must not carry an `estimate` field
- Exact runtime states are only `ESTIMATE_AVAILABLE` / `UNKNOWN`; any other state is `COST_INVALID`
