...
attempt1_dispatch_id: dsp_19 — killed pid 23648 — state EXPIRED
attempt2_dispatch_id: dsp_23 — attempt_number 2 — fence differs
...
Canary hardening included on this branch (still Slice 2 candidate; not B1 graduation):
